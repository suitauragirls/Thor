    ...
    <div id="admin-products-page" className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-\[#FAF7F5\] p-5 rounded-2xl border border-rose-100 shadow-xs">
        ...
        <button
          ...
          className="px-5 py-2.5 bg-[#58152D] hover:bg-[#7E1D3B] text-white rounded-xl text-xs font-bold tracking-wider uppercase transition shadow-sm flex items-center gap-2 cursor-pointer self-start sm:self-auto"
        >
      ...
      <div className="bg-\[#FAF7F5\] p-4 rounded-2xl border border-rose-100 shadow-xs grid grid-cols-1 sm:grid-cols-12 gap-3">
        ...
        <div className="sm:col-span-6 relative">
          <input
            ...
            className="w-full pl-9 pr-4 py-2 border border-gray-200 rounded-xl text-xs focus:outline-none focus:ring-1 focus:ring-[#58152D] text-gray-900"
          />
        ...
        <div className="sm:col-span-3">
          <select
            ...
            className="w-full px-3 py-2 border border-gray-200 rounded-xl text-xs bg-\[#FAF7F5\] text-gray-700 focus:outline-none focus:ring-1 focus:ring-[#58152D]"
          >
      ...
      {/* Products Table */}
      <div className="bg-\[#FAF7F5\] rounded-2xl border border-rose-100 shadow-xs overflow-hidden">
            ...
            <tbody className="divide-y divide-gray-100">
              {filteredProducts.length === 0 ? (
                ...
                filteredProducts.map((product) => {
                  ...
                  return (
                    <tr key={product.id} className="hover:bg-[#E0BFB8]/20 transition">
                          ...
                          <button
                            ...
                            className={`inline-flex items-center gap-0.5 text-[9px] font-bold px-1.5 py-0.5 rounded cursor-pointer transition ${
                              product.isBestSeller 
                                ...
                                : 'bg-gray-100 text-gray-500 hover:bg-amber-50 hover:text-amber-800'
                            }`}
                          ...
                          <button
                            ...
                            className={`inline-block text-[9px] font-bold px-1.5 py-0.5 rounded cursor-pointer transition ${
                              product.isNewArrival
                                ? 'bg-[#E0BFB8]/40 text-[#58152D] border border-rose-200'
                                : 'bg-gray-100 text-gray-500 hover:bg-[#E0BFB8]/20 hover:text-[#58152D]'
                            }`}
                      ...
                      {/* 4. Price */}
                      <td className="py-3 px-4">
                        <p className="font-bold text-[#58152D] text-sm">
                      ...
                      <td className="py-3 px-4">
                        <div className="flex items-center gap-2">
                          <button
                            ...
                            className="p-1 hover:bg-[#E0BFB8]/40 rounded-md text-gray-500"
                          >
                            -
                          </button>
                      ...
                      <td className="py-3 px-4 text-right">
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="p-1.5 text-gray-600 hover:text-[#58152D] hover:bg-[#E0BFB8]/20 rounded-lg transition cursor-pointer"
                            title="Edit product"
                          >
                          ...
                          <button
                            ...
                            className="p-1.5 text-gray-600 hover:text-rose-700 hover:bg-[#E0BFB8]/20 rounded-lg transition cursor-pointer"
      ...
      {deleteConfirmId && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-xs flex items-center justify-center p-4">
          <div className="bg-\[#FAF7F5\] rounded-2xl max-w-sm w-full p-6 shadow-xl space-y-4 border border-rose-100 animate-in fade-in zoom-in-95">
            <div className="w-12 h-12 rounded-full bg-[#E0BFB8]/40 text-rose-700 flex items-center justify-center mx-auto">
