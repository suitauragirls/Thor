    ...
    <section id="instagram-gallery-section" className="py-8 sm:py-12 bg-[#FFFDFC]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-xl mx-auto mb-12">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-[#E0BFB8]/20 border border-rose-100 text-[#58152D] text-xs font-semibold uppercase tracking-widest mb-2">
          ...
          <p className="text-xs sm:text-sm text-gray-600 mt-2">
            Discover our latest styles. Tag <span className="font-semibold text-[#58152D]">#SuitBlissAura</span> on Instagram to be featured on our official lookbook.
          </p>
        </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-4">
          {galleryItems.map((item) => (
            <div
              ...
              className="group relative aspect-[3/4] rounded-xl overflow-hidden cursor-pointer shadow-xs bg-[#E0BFB8]/20 border border-rose-100"
            >
              {item.image && (
                <img
                  src={item.image}
                  alt="Suit Bliss Aura Lookbook"
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col justify-between p-3 text-white">
                ...
                <div>
                  <p className="text-[11px] font-bold text-[#DFBE65] truncate">{item.tag}</p>
